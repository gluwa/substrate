...
param vmName string = toLower('github-runner-${uniqueString(resourceGroup().id, utcValue)}')
...
output sshUserAtHostname string = '${adminUsername}@${publicIP.properties.dnsSettings.fqdn}'
